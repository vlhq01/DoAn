...
class MoneyTopUpAdapter(
    private var mListData: ArrayList<TopUpValue>,
    var mcallback: TopUpValueItemClickListener
    ...
    inner class TopUpValueViewHolder(val binding: TopupvalueItemBinding) :
